dataSetVersion = "2025-07-16"; // Change this when creating a new data set version. YYYY-MM-DD format.
...
dataSet[dataSetVersion].options = [
  {
    ...
    name: "Filter by Difficulty",
      key: "saga",
      tooltip: "Check this to restrict to characters by importance and fame",
      checked: true,
      sub: [
        { name: "Easy", key: "d1" },
        { name: "Medium", key: "d2" },
  ...
  dataSet[dataSetVersion].characterData = [
    ...
    {
      name: "Jiron",
      img: "690JironManga.jpeg",
      opts: {
        saga: [ "s11"],
      }
    },
    {
      name: "Saint Fingarland Garling",
      img: "691GarlingManga.jpeg",
      opts: {
        saga: [ "s11"],
      }
    },
